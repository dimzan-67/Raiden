...
local library = utility.table({theme = table.clone(themes.Raiden), folder = "Raiden Hub", extension = "cfg", flags = {}, open = false, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "Raiden"}
...
function library:Load(options)
	...
	local name = "Raiden Hub"
	local sizeX = options.sizex or 450
	local sizeY = options.sizey or 500
	local theme = options.theme and options.theme or "Raiden"
